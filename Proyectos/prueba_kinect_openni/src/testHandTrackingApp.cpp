...
//--------------------------------------------------------------
void testHandTrackingApp::setup() {
...
//--------------------------------------------------------------
void testHandTrackingApp::update(){
    openNIDevice.update();
...
//--------------------------------------------------------------
void testHandTrackingApp::handEvent(ofxOpenNIHandEvent & event){
    // show hand event messages in the console
    ofLogNotice() << getHandStatusAsString(event.handStatus) << "for hand" << event.id << "from device" << event.deviceID;
}

//--------------------------------------------------------------
void testHandTrackingApp::exit(){
    openNIDevice.stop();
}

//--------------------------------------------------------------
void testHandTrackingApp::keyPressed(int key){

}

//--------------------------------------------------------------
void testHandTrackingApp::keyReleased(int key){

}

//--------------------------------------------------------------
void testHandTrackingApp::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void testHandTrackingApp::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void testHandTrackingApp::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void testHandTrackingApp::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void testHandTrackingApp::windowResized(int w, int h){
