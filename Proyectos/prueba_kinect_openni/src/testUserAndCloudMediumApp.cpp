...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::setup() {
    ...
    ofAddListener(openNIDevices[0].userEvent, this, &testUserAndCloudMediumApp::userEvent);
...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::update(){
    ofBackground(0, 0, 0);
    for (int deviceID = 0; deviceID < numDevices; deviceID++){
...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::draw(){
...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::userEvent(ofxOpenNIUserEvent & event){
    ofLogNotice() << getUserStatusAsString(event.userStatus) << "for user" << event.id << "from device" << event.deviceID;
}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::exit(){
...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::keyPressed(int key){
    int cloudRes = -1;
    switch (key) {
        case '1':
            cloudRes = 1;
...
//--------------------------------------------------------------
void testUserAndCloudMediumApp::keyReleased(int key){

}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::mouseMoved(int x, int y ){

}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::mouseDragged(int x, int y, int button){

}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::mousePressed(int x, int y, int button){

}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::mouseReleased(int x, int y, int button){

}

//--------------------------------------------------------------
void testUserAndCloudMediumApp::windowResized(int w, int h){
