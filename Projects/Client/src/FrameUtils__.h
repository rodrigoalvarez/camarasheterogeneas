...
class FrameUtils {
    ...
    static ThreadData * getDummyFrame() {
        ...
        tData[0].xpix       = new float[tData[0].nubeLength];
        tData[0].ypix       = new float[tData[0].nubeLength];
        tData[0].zpix       = new float[tData[0].nubeLength];
        ...
        tData[1].xpix       = new float[tData[0].nubeLength];
        tData[1].ypix       = new float[tData[0].nubeLength];
        tData[1].zpix       = new float[tData[0].nubeLength];
